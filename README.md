...
This add-on improves the presentation on the website [MyAnimeList](https://myanimelist.net/).
...
Instead, a new table present the different appearances grouped with a single line for each character.
...
- The "Role" column acts as a filter.
